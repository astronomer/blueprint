...
Space-themed example demonstrating many Blueprint features: versioning, runtime params, custom DAG args, Jinja2 templating, `on_dag_built` callbacks, programmatic DAG building with the `Builder` API, blueprints shared via an installed package ([shared-blueprints/](shared-blueprints/)), and more.
